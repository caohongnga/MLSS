...
gpu_inference=false #false  # Whether to perform gpu decoding.
dumpdir=dump   #/home/nga/data/local_1t_c/data/Nga/espdata/dump
#dumpdir=/home/nga/data/local_1t_a/Nga/espdata/dump         # Directory to dump features.
...
nbpe=4004 #4000 cs01 #4005 #3500 #4500 #4004       #5003    # The number of BPE vocabulary.
...
lm_tag=cs_4004_hyptext_1x0 #cs_4005_len3s #cs_4000_len3s #cs_4004_len3s   #rnn_lm           # Suffix to the result dir for language model training.
...
# ASR model related
asr_tag=semi4004_th90_iter1 #baseline_4004_001     # Suffix to the result dir for asr model training.
...
inference_args="--beam_size 1 --lm_weight 0"   # Arguments for decoding, e.g., "--lm_weight 0.1".
                  # Note that it will overwrite args in inference config.
inference_lm=valid.loss.ave_8best.pth  #valid.loss.ave.pth       # Language modle path for decoding.
inference_asr_model=valid.acc.ave_6best.pth #valid.acc.best.pth # ASR model path for decoding. 
                                      # e.g.
...
train_set="train_set5" #"cs_train_th90_iteration1"       # Name of training set.
valid_set="val_set5"       # Name of validation set used for monitoring/tuning network training.
test_sets="nsc_all" #"dev_man_p1 dev_sge_p1 dev_man dev_sge" #"train_th90_iteration1" #"dev_man_p1 dev_sge_p1 dev_man dev_sge  #""nsc_all" #"nsc"  #"dev_man_p1 dev_sge_p1 dev_man dev_sge" #"val_set5"  #"dev_man_p1 dev_sge_p1 dev_man dev_sge" #"dev_man dev_sge" #"dev_man_p1 dev_sge_p1 dev_man dev_sge" # dev_man_p1 dev_sge_p1"       # Names of test sets. Multiple items (e.g., both dev and eval sets) can be specified.
bpe_train_text=  # Text file path of bpe training set.
lm_train_text=dump/raw/lm_train.txt #data/train/text   # Text file path of language model training set.
lm_dev_text=/home/nga/nemo/espnet/egs2/cs_sm_nsc/asr1/dump/raw/val_set5/text     # Text file path of language model development set.
lm_test_text=/home/nga/nemo/espnet/egs2/cs_sm_nsc/asr1/dump/raw/dev/text    # Text file path of language model evaluation set.
